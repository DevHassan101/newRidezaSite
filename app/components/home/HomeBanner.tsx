...
const HiLocationMarker = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 lg:w-5.5 lg:h-5.5" viewBox="0 0 256 256"><path fill="#06b6d4" d="M128 16a88.1 88.1 0 0 0-88 88c0 75.3 80 132.17 83.41 134.55a8 8 0 0 0 9.18 0C136 236.17 216 179.3 216 104a88.1 88.1 0 0 0-88-88m0 56a32 32 0 1 1-32 32a32 32 0 0 1 32-32" strokeWidth="3" stroke="#06b6d4" /></svg>
);
    ...
    return (
        <>
            <section className="hero-banner">
                <div className="hero-image relative h-screen lg:h-auto">
                    ...
                    <div className="hero-image-overlay w-full absolute top-0 left-0 h-full flex items-center justify-center"
                        ...
                        <div className="w-full hero-overlay mt-15">
                            <div className="hero-box2 max-w-[85%] lg:max-w-[55%] mx-auto mt-5 lg:mt-0">
                                <div className="space-y-6 flex lg:block flex-wrap justify-center items-center">
                                    ...
                                    <div className="bg-white rounded-[18px] shadow-2xl py-6 px-5.5 lg:py-6 lg:px-6 space-y-5">
