...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-64 right-0 h-17 bg-white/90 backdrop-blur-sm border-b border-cyan-100 flex items-center px-6 gap-4 z-30 shadow-sm shadow-cyan-50">
            ...
            <div className="relative w-64">
                ...
                <input
                    ...
                    className="w-full border-2 border-zinc-200 bg-zinc-50 text-zinc-700 placeholder-zinc-400 rounded-xl pl-9 pr-4 py-2 text-[13.5px] focus:outline-none focus:border-cyan-400 focus:bg-white focus:ring-2 focus:ring-cyan-100 transition-all duration-200"
                />
            </div>
